...
////////////////////////////////////////////////////////////
/// \brief Convert cartesian state vectors to orbital elements
/// \ingroup otl
/// 
/// Calculates the classical orbital elements of an object
/// given its cartesian position and velocity (state) vectors.
///
...
/// \ingroup otl
///
/// Calculates the cartesian position and velocity (state)
/// vectors of an object given its classical orbital elements.
///
...
OTL_CORE_API double ConvertMeanAnomalyToAnomaly(double eccentricity, double meanAnomaly);
OTL_CORE_API double ConvertMeanAnomalyToEccentricAnomaly(double eccentricity, double meanAnomaly);
OTL_CORE_API double ConvertMeanAnomalyToHyperbolicAnomaly(double eccentricity, double meanAnomaly);
